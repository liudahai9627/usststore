package com.usststore.order.utils;
...
import com.usststore.order.config.PayConfig;
...
public class PayHelper {
    ...
    public void isSuccess(Map<String, String> result) {
        ...
        if (FAIL.equals(returnCode)){
            ...
            throw new UsException(ExceptionEnum.WX_PAY_ORDER_FAIL);
        }
    ...
    public void isValidSign(Map<String, String> data) {
        ...
        try {
            ...
            if (! StringUtils.equals(sign,sign1) && !StringUtils.equals(sign,sign2)) {
                //签名有误
                throw new UsException(ExceptionEnum.INVALID_SIGN_ERROR);
            }
        } catch (Exception e) {
            throw new UsException(ExceptionEnum.INVALID_SIGN_ERROR);
